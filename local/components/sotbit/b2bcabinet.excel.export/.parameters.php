...
$arComponentParameters = [
    ...
    "PARAMETERS" => array(
        ...
        // "MODEL_OF_WORK" => array(
        //     "PARENT" => "BASE",
        //     "NAME" => Loc::GetMessage("B2B_EXCEL_EXPORT_MODEL_OF_WORK"),
        //     "TYPE" => "LIST",
        //     "VALUES" => [
        //         "default" => Loc::GetMessage("B2B_EXCEL_EXPORT_MODEL_OF_WORK_DEFAULT"),
        //         "user_config" => Loc::GetMessage("B2B_EXCEL_EXPORT_MODEL_OF_WORK_USER_CONFIG"),
        //     ],
        // ),
        "SORT_BY" => Array(
            "PARENT" => "DATA_SOURCE",
