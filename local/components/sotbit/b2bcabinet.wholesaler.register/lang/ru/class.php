...
$MESS ['REGISTER_FIELD_ERROR_REQUIRED'] = "Не заполнено обязательное поле #FIELD#";
$MESS ['REGISTER_WRONG_CAPTCHA'] = "Неверно введено слово с картинки";
$MESS ['REGISTER_ERROR_WHOLESALER_EXIST'] = "Организация с такими данными уже сущетсвует в системе";
$MESS ['REGISTER_ERROR_MODULE_NOT_INSTALL'] = "Модуль #MODULE_NAME# не установлен";
$MESS ['REGISTER_ERROR_DISABLE_REGISTRATION'] = "Регистрация пользователя недоступна";
$MESS ['REGISTER_ERROR_NO_PERSON_TYPE'] = "В настройках решения B2B Кабинет не выбраны доступные типы плательщика";