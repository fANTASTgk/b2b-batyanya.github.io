...
$arComponentParameters = array(
	...
	"PARAMETERS" => array(
		...
		"BASKET_PAGE_URL" => array(
			"NAME" => GetMessage("SOTBIT_MULTIBASKET_PATH_TO_BASKET_PAGE"),
			"TYPE" => "STRING",
			"DEFAULT" => '={SITE_DIR."personal/cart/"}',
			"PARENT" => "BASE",
		),
		"ONLY_BASKET_PAGE_RECALCULATE" => array(
			"NAME" => GetMessage("SOTBIT_MULTIBASKET_ONLY_BASKET_PAGE_RECALCULATE"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "N",
			"PARENT" => "BASE",
		),
		"RECALCULATE_BASKET" => array(
			"NAME" => GetMessage("SOTBIT_MULTIBASKET_RECALCULATE_BASKET"),
			"TYPE" => "LIST",
			"VALUES"=>array(
				"PAGE_RELOAD" => GetMessage("SOTBIT_MULTIBASKET_PAGE_RELOAD"),
				"EVENT" => GetMessage("SOTBIT_MULTIBASKET_EVENT"),
			),
			"DEFAULT" => "PAGE_RELOAD",
			"PARENT" => "BASE",
		),
