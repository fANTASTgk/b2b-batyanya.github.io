<?
$MESS['SOTBIT_MULTIBASKET_PATH_TO_BASKET_PAGE'] = 'Путь к странице корзины';
$MESS['SOTBIT_MULTIBASKET_ONLY_BASKET_PAGE_RECALCULATE'] = 'Пересчёт корзины только на странице корзины';
$MESS['SOTBIT_MULTIBASKET_RECALCULATE_BASKET'] = 'Способ обновления корзины при переключении мультикорзины';
$MESS['SOTBIT_MULTIBASKET_PAGE_RELOAD'] = 'Перезагрузка страницы';
$MESS['SOTBIT_MULTIBASKET_EVENT'] = 'По событию "sotbitMultibasketSwitch"';
