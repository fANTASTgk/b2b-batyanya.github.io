...
function addToBasket() {
    BX.showWait();
    const template_id = document.querySelector("#ordertemplates-addbasket-block").getAttribute('data-id');
...
function showRemoveForm(templateId, templateName) {
    ...
    const formRemove = popupRemove.querySelector("#ordertemplates-remove-block");
...
function removeTemplate() {
    BX.showWait();
    const template_id = document.querySelector("#ordertemplates-remove-block").getAttribute('data-id');
    ...
    request.then(function (response) {
        ...
        closeModal();
        const successBlock = document.querySelector(".popup-order-remove-success");
        let description = successBlock.querySelector(".form-description");
        description.textContent = success_descr.replace("#TEMPLATE_NAME#", TEMPLATE_NAME);
        successBlock.style.display = "flex";
    });
}

function exportExcelTemplate(templateId) {
    BX.showWait();
    let prod = new Object();
