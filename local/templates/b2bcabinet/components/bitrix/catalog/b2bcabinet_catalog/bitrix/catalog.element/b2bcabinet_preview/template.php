...
\Bitrix\Main\Page\Asset::getInstance()->addCss(SITE_TEMPLATE_PATH. "/components/bitrix/catalog/b2bcabinet_catalog/bitrix/catalog.element/b2bcabinet_preview/style.css");
\Bitrix\Main\Page\Asset::getInstance()->addCss(SITE_TEMPLATE_PATH. "/components/bitrix/catalog/b2bcabinet_catalog/bitrix/catalog.element/b2bcabinet_preview/assets/fancybox/jquery.fancybox_custom.css");
\Bitrix\Main\Page\Asset::getInstance()->addJs(SITE_TEMPLATE_PATH. "/components/bitrix/catalog/b2bcabinet_catalog/bitrix/catalog.element/b2bcabinet_preview/script.min.js");
\Bitrix\Main\Page\Asset::getInstance()->addJs(SITE_TEMPLATE_PATH. "/components/bitrix/catalog/b2bcabinet_catalog/bitrix/catalog.element/b2bcabinet_preview/assets/fancybox/jquery.fancybox_custom.min.js");
\Bitrix\Main\Page\Asset::getInstance()->addJs(SITE_TEMPLATE_PATH. "/components/bitrix/catalog/b2bcabinet_catalog/bitrix/catalog.element/b2bcabinet_preview/assets/lightBox/js/lightbox.min.js");
\Bitrix\Main\Page\Asset::getInstance()->addCss(SITE_TEMPLATE_PATH. "/components/bitrix/catalog/b2bcabinet_catalog/bitrix/catalog.element/b2bcabinet_preview/assets/lightBox/css/lightbox.min.css");
            ...
            <?if(!$arResult['haveOffers']):?>
                ...
                <?if(!empty($price['PRINT_PRICE'])):?>
                    <div class="aside-block__price-wrap price-wrap">
                        <?if (Bitrix\Main\Loader::includeModule( "sotbit.privateprice" ) && \Bitrix\Main\Config\Option::get("sotbit.privateprice", "MODULE_STATUS", 0) && Bitrix\Main\Loader::includeModule( "currency" )):
...
?>
	<script>
        ...
        var quickViewObject = new QuickView('.quick-view').init();
	</script>
<?
