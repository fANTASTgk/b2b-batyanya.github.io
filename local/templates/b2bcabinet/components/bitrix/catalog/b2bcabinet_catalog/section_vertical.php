...
} elseif (!$_SESSION['only_available']) {
    $_SESSION['only_available'] = $arParams["HIDE_NOT_AVAILABLE"];
}
...
if(Loader::includeModule('iblock') && Loader::includeModule('catalog') && $_SESSION['only_checked'] == 'Y')
{
...
$arSectionsFilter = array("IBLOCK_ID" => $arParams['IBLOCK_ID'], "ACTIVE" => "Y");
...
elseif ($cache->startDataCache())
{
    ...
    $res = CIBlockSection::GetList(Array("SORT" => "asc"), $arSectionsFilter, false, $arSectionsSelect);
    ...
    <div class="card">
		...
		<div class="index_blank-table">
			...
			$intSectionID = $APPLICATION->IncludeComponent(
				...
				"",
				array(
                    "SHOW_BTN_ADD_TO_BASKET" => (!isset($_SESSION['BLANK_IDS']) || empty($_SESSION['BLANK_IDS'])) ? "N" : "Y",
                    "IBLOCK_TYPE" => $arParams["IBLOCK_TYPE"],
					"IBLOCK_ID" => $arParams["IBLOCK_ID"],
