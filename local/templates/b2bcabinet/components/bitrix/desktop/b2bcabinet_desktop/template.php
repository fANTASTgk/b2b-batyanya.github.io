	...
	if($arResult["PERMISSION"] > "R")
	{
		...
		<div class="sw--all_widgets">
            <div class="widget-bx-gd-buttons">
                <ul class="fab-menu fab-menu-absolute fab-menu-top-right" data-fab-position="custom" data-fab-toggle="click">
                    <li>
                        <a class="fab-menu-btn btn btn-float rounded-pill btn-icon">
                        ...
                        <ul class="fab-menu-inner">
                            <? if($arResult["PERMISSION"]>"W"):?>
                                ...
                                ?>
                                <li>
                                    <div data-fab-label="<?=Loc::getMessage('CMDESKTOP_TDEF_SET')?>">
                                        <button type="button"
                                                class="btn btn-light rounded-pill btn-icon btn-float"
                                                onclick="getGadgetHolderSC('<?=AddSlashes($arResult["ID"])?>').SetForAll(<?=$mode?>);"
                                        >
                            ...
                            <li>
                                <div data-fab-label="<?=Loc::getMessage('CMDESKTOP_TDEF_CLEAR')?>">
                                    <button type="button"
                                            class="btn btn-light rounded-pill btn-icon btn-float"
                                            onclick="getGadgetHolderSC('<?=AddSlashes($arResult["ID"])?>').ClearUserSettingsConfirm();"
                                    >
                            ...
                            <li>
                                <div data-fab-label="<?=Loc::getMessage('CMDESKTOP_TDEF_ADD_WIDGET')?>">
                                    <button type="button"
                                            class="btn btn-light rounded-pill btn-icon btn-float"
                                            onclick="getGadgetHolderSC('<?= AddSlashes($arResult["ID"]) ?>').ShowAddGDMenu(this); closeFade();"
                                    >
...
function closeFade() {
    const fadeBtn = document.querySelector('.widget-bx-gd-buttons .fab-menu-btn');
    fadeBtn.click();
}
</script>