...
$methodIstall = Option::get('sotbit.b2bcabinet', 'method_install', '',
...
<div class="sidebar-user">
    ...
    ?>
    <div class="sidebar-user bx-user-info-anchor" id="anchor_<?= $anchor_id ?>"
         bx-tooltip-user-id="<?= $tooltipUserId ?>"><?
        } else {
        ?>
        <div class="sidebar-user bx-user-info-anchor-nolink" id="anchor_<?= $anchor_id ?>"
             bx-tooltip-user-id="<?= $tooltipUserId ?>"><?
            }
            ?>
            <div class="card-body">
                <div class="media"><?
                    ...
                    <div class="media-body font-weight-semibold bx-user-info-anchor-cell" valign="top"><?
                        if (strlen($arResult["User"]["HREF"]) > 0) {
                            ?><a
                            class="bx-user-info-name" href="<?= $arResult["User"]["HREF"] ?>"<?= ($arParams["SEO_USER"] == "Y" ? ' rel="nofollow"' : '') ?>><?= $arResult["User"]["NAME_FORMATTED"] ?></a><?
                        } elseif (strlen($arResult["User"]["DETAIL_URL"]) > 0 && $arResult["CurrentUserPerms"]["Operations"]["viewprofile"]) {
                            ?><a
                            class="bx-user-info-name" href="<?= $arResult["User"]["DETAIL_URL"] ?>"<?= ($arParams["SEO_USER"] == "Y" ? ' rel="nofollow"' : '') ?>><?= $arResult["User"]["NAME_FORMATTED"] ?></a><?
                        } else {
                            ?>
