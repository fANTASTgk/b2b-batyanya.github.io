                                        ...
                                        <div class="form-group row js-fixedpay-container">
                                            ...
                                            <div class="col-lg-9">
                                                ...
                                                foreach ($arParams["SELL_TOTAL"] as $valueChanging) {
                                                    ?>
                                                    <button type="button" class="btn btn-light js-fixedpay-item btn-pay">
                                                ...
                                                foreach ($arResult['PAYSYSTEMS_LIST'] as $key => $paySystem) {
                                                    ...
                                                    <li class="nav-item">
                                                        ...
                                                        >
                                                            ...
                                                            <i class="<?= (!empty($styleClassesForPaySystemIcons[$paySystem['IS_CASH']]) ? $styleClassesForPaySystemIcons[$paySystem['IS_CASH']] : "") ?> mr-2"></i>
                                                                </span>
                                                            <?=$paySystem['NAME']?>
                                                        </a>
                                                    </li>
