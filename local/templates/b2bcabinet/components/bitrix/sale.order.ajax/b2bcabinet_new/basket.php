...
<div class="row">
    <div class="col-md-12">
        <div class="card <?=$arParams["HIDDEN_BASKET"] == "Y" ? "card-collapsed" : ""?>">

            <div class="card-header header-elements-inline">
                <h5 class="card-title"><?=GetMessage("SOA_TEMPL_BASKET")?></h5>
                <div class="header-elements">
                    <div class="list-icons">
                        <a class="list-icons-item <?=$arParams["HIDDEN_BASKET"] == "Y" ? "rotate-180" : ""?>" data-action="collapse"></a>
                    </div>
                </div>
            </div>
            <div class="card-body index_checkout-table">
                        ...
                        <div class="index_checkout-promocode-total">
                            <div>
                                <div class="index_checkout-promocode-total_text">
                                    ...
                                    <h4>
                                        <span class="index_checkout-promocode-total_amount"><?=$arResult["ORDER_PRICE_FORMATED"]?></span>
                                    </h4>
                                </div>
