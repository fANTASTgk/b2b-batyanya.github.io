...
<div class="card-body checkout_form">
    ...
    <?php if (!empty($arResult["ORDER"])): ?>
        <?php
        $linkDetail = Config::getMethodInstall(SITE_ID) == 'AS_TEMPLATE' ? SITE_DIR.\SotbitB2bCabinet::PATH . '/' : SITE_DIR;
        $linkDetail .= 'orders/detail/'.$arResult["ORDER"]['ACCOUNT_NUMBER'].'/';
        ?>
        <div>
                                ...
                                <label class="form-check-label">
                                    ...
                                    <div class="index_checkout-delivery_text">
                                        ...
                                        <div class="index_checkout-radios_description">
                                            ...
                                            } else if ($arResult["PAY_SYSTEM"]["BUFFERED_OUTPUT"]) {
