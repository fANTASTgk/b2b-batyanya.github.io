...
while($resultStatus = $dbstatus->Fetch()){
    ...
    if ($resultStatus["COLOR"]) {
        $color = '<span class="b2b-badge mr-2" style="background-color: '.$resultStatus["COLOR"].'!important;"></span>';
    }
    $arResult['INFO']['STATUS'][$resultStatus["ID"]]["PRINT"] = '<div class="b2b-orderlist-status">'.$color.'<span>'.$resultStatus["NAME"].'</span><span class="badge badge-flat badge-pill border-danger text-danger-600 ml-2">#CANCELED#</span></div>';
}
