...
$MESS["AUTH_TITLE"] = "Вход в аккаунт";
$MESS["AUTH_TITLE_DATA"] = "Ваши учетные данные";
...
$MESS["AUTH_NOT_REGISTER"] = "Не зарегистрированы?";
...
$MESS['ACCOUNT_HAVNT_RIGHTS'] = "Ваш аккаунт не имеет доступа к данному ресурсу.";
$MESS['AUTH_QUESTION_MAIL'] = 'По вопросам обращаться <a href="mailto:#MAIL#">на почту</a>';
//$MESS["AUTH_OBLIGATION_NOTE"] = "Продолжая, вы даёте согласие на обработку персональных данных и соглашаетесь с <a
// href=\"/help/confidentiality/\"> политикой конфиденциальности</a>";
?>