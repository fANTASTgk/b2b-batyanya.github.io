        ...
        <div class="card mb-0">
            <div class="card-body">
                ...
                <div class="form-group form-group-feedback form-group-feedback-left">
                    <input type="text" class="form-control" maxlength="255" name="USER_LOGIN"
                    ...
                    <div class="form-group form-group-feedback form-group-feedback-left">
                        ...
                        <div class="bx-captcha">
                            <input class="form-control" type="text" name="captcha_word" maxlength="50" value=""
                                   autocomplete="off" placeholder="<?= GetMessage("AUTH_CAPTCHA_PROMT") ?>"/>
                        </div>
                    </div>
                <? endif; ?>
                ...
                <div class="form-group d-flex align-items-center">
                    ...
                    <a href="<?= $arResult["AUTH_FORGOT_PASSWORD_URL"] ?>"
                       class="ml-auto"><?= GetMessage("AUTH_FORGOT_PASSWORD_2") ?></a>
                </div>

                <div class="form-group">
                    <button type="submit" class="btn btn-primary btn-block"><?= GetMessage("AUTH_AUTHORIZE") ?> <i
                ...
                <? if (\Bitrix\Main\Config\Option::get('main', 'new_user_registration') == 'Y'): ?>
                    ...
                    <div class="form-group">
                        <a href="<?= $arResult["AUTH_REGISTER_URL"] ?>"
                           class="btn btn-light btn-block"><?= GetMessage("AUTH_REGISTER") ?></a>
                    </div>
                <? endif; ?>
