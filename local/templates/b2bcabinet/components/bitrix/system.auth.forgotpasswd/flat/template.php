    ...
    <div class="card mb-0">
        <div class="card-body">
            ...
            <div class="form-group form-group-feedback form-group-feedback-right">
                <input type="email" name="USER_EMAIL" maxlength="255" value="<?= $arResult["LAST_LOGIN"] ?>"
                       class="form-control" placeholder="E-Mail" autocomplete="off" required/>
            ...
            <button type="submit" class="btn bg-blue btn-block"><i
                        class="icon-spinner11 mr-2"></i><?= GetMessage("AUTH_SEND") ?></button>
            <a href="<?= $arResult["AUTH_AUTH_URL"] ?>" class="btn bg-blue btn-block"><?= GetMessage("AUTH_AUTH") ?></a>
        </div>
    </div>
</form>