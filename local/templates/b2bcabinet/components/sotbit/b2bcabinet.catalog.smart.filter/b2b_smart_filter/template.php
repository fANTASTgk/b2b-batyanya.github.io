            ...
            <div class="card-body">
                ...
                foreach ($arResult["ITEMS"] as $key => $arItem) {
                    ...
                    if (isset($arItem["PRICE"])):
                        if (($arItem["VALUES"]["MAX"]["VALUE"] - $arItem["VALUES"]["MIN"]["VALUE"] <= 0) || !in_array($arItem["CODE"], $arParams["FILTER_PRICE_CODE"]))
                            continue;
                                        ...
                                        foreach ($arItem["VALUES"] as $val => $ar):
                                            ...
                                            <div class="bx_filter_parameters_box_checkbox form-check <? echo $ar["DISABLED"] ? 'disabled' : '' ?>">
                                                <label class="form-check-label checkbox__label fonts__middle_comment"
                                                    ...
                                                    <input type="checkbox" class="checkbox_custom_filter"
