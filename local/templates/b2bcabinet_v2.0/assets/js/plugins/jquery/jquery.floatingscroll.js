class FScroll {
    constructor(cont) {
        ...
        inst.heightCatalogFooter = document.querySelector('.catalog__footer')?.clientHeight ?? 0;
    ...
    addEventHandlers() {
        ...
        let eventHandlers = inst.eventHandlers = [
            ...
            {
                $el: $('.content-inner').length ? $('.content-inner') : $(document.body),
                handlers: {
                    scroll() {
                        inst.checkVisibility();
                    }
    ...
    checkVisibility() {
        ...
        if (!mustHide) {
            ...
            maxVisibleY -= inst.heightCatalogFooter;
