                            ...
                            if (is_array($property) && $propertyCode == 'PRICES') {
                                foreach ($property as $singlePropertyCode => $singleProperty) {
                                    ...
                                    <th class="blank-zakaza__header-property
                                        ...
                                        data-sort-order="<?= (!empty($request['SORT']['ORDER']) && $request['SORT']['CODE'] === "PRICE_" . $singleProperty["ID"]) ? $request['SORT']['ORDER'] : '' ?>">
                                        <?=$singleProperty["NAME"]?>
                                    </th>
                                    <?
                                }
                            ...
                            elseif (is_array($property)) {
                                ...
                                if ($property == $arParams['TABLE_HEADER']['NAME']) {
                                    ...
                                    <th colspan="2" class="blank-zakaza__header-property
                                        ...
                                        data-sort-order="<?= (!empty($request['SORT']['ORDER']) && $request['SORT']['CODE'] === $propertyCode) ? $request['SORT']['ORDER'] : '' ?>">
                                    ...
                                    <th class="blank-zakaza__header-property
                                        ...
                                        data-sort-order="<?= (!empty($request['SORT']['ORDER']) && $request['SORT']['CODE'] === "PROPERTY_".$propertyCode) ? $request['SORT']['ORDER'] : '' ?>">
                                        <?=$property?>
                                    </th>
                                    <?
                                }
