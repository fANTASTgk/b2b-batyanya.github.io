...
$componentElementParams = [
    ...
    'CATALOG_NOT_AVAILABLE'      => $arParams["CATALOG_NOT_AVAILABLE"] ?? "N",
    ...
    // Property article, files, brand
    'DETAIL_MAIN_ARTICLE_PROPERTY'           => isset($arParams['DETAIL_MAIN_ARTICLE_PROPERTY'])
        ? $arParams['DETAIL_MAIN_ARTICLE_PROPERTY'] : '',
    'DETAIL_MAIN_ARTICLE_PROPERTY_OFFERS'           => isset($arParams['DETAIL_MAIN_ARTICLE_PROPERTY_OFFERS'])
        ? $arParams['DETAIL_MAIN_ARTICLE_PROPERTY_OFFERS'] : '',
    'DETAIL_MAIN_BRAND_PROPERTY'           => isset($arParams['DETAIL_MAIN_BRAND_PROPERTY'])
        ? $arParams['DETAIL_MAIN_BRAND_PROPERTY'] : '',
    'DETAIL_MAIN_FILES_PROPERTY'           => isset($arParams['DETAIL_MAIN_FILES_PROPERTY'])
        ? $arParams['DETAIL_MAIN_FILES_PROPERTY'] : '',
    'DETAIL_CROSSSELL_STATUS' => isset($arParams['DETAIL_CROSSSELL_STATUS'])
        ? $arParams['DETAIL_CROSSSELL_STATUS'] : '',
    'DETAIL_CROSSSELL_SECTION_MODE' => isset($arParams['DETAIL_CROSSSELL_SECTION_MODE'])
        ? $arParams['DETAIL_CROSSSELL_SECTION_MODE'] : '',
    'DETAIL_CROSSSELL_LIST' => isset($arParams['DETAIL_CROSSSELL_LIST'])
        ? $arParams['DETAIL_CROSSSELL_LIST'] : '',
