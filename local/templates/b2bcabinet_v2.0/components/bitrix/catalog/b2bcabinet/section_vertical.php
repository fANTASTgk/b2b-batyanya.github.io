        ...
        <? if ($isFilter): ?>
            <div class="flex-md-grow-1">
                <div 
                    ...
                    class="catalog__filter-toggler btn btn-sm btn-icon btn-primary fs-5 <?=$positionSideBar !== 'LEFT' ? 'catalog__filter-toggler-position-left' : ''?>"
                >
                    <i class="ph-funnel catalog__filter-toggler-icon fs-5"></i>
                </div>
            </div>
        <? endif; ?>
        <?
