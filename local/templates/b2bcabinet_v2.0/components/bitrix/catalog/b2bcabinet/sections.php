...
if (\Bitrix\Main\Config\Option::get('sotbit.b2bcabinet', 'CATALOG_SECTION_ROOT_TEMPLATE', 'SECTIONS_LIST', SITE_ID) === 'PRODUCTS_LIST') {
    require $_SERVER["DOCUMENT_ROOT"] . SITE_TEMPLATE_PATH . '/components/bitrix/catalog/b2bcabinet/section.php';
    return;
}
...
<div class="catalog">
    <div class="catalog__wrapper">
        <div id="card card__catalog__section-wrapper" class="catalog__section-wrapper">
