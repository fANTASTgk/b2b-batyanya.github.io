...
foreach ($arResult['GADGETS'] as $colGadget) {
	foreach ($colGadget as $gadget) {
		if(array_key_exists($gadget['GADGET_ID'], $arResult['ALL_GADGETS'])) {
			$arResult['ALL_GADGETS'][$gadget['GADGET_ID']]['ACTIVE'] = 'Y';
			$arResult['ALL_GADGETS'][$gadget['GADGET_ID']]['ELEMENTS_ID'][] = $gadget['ID'];
		}
	}
}
?>