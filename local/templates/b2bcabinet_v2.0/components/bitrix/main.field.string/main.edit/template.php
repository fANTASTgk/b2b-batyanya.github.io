...
?>
    <div class="blank_detail">
        ...
        <div class="tab-content mt-4">
            ...
            <div class="tab-pane fade show active" id="basic-tab1">
                <div class="card-columns card-columns-3">
                    <div class="card">
                        <div class="card-header card-p-1 d-flex flex-wrap">
                        ...
                        <div class="collapse show">
                            <div class="card-body card-p-1 pt-0">
        ...
        <div class="card card-position-sticky card-bottom--1 blank_detail_actions">
            <div class="card-body d-flex gap-custom-1">
