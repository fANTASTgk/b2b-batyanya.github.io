    ...
    $APPLICATION->IncludeComponent(
        ...
        array(
            ...
            'HEADERS' => array(
                ...
                array("id" => "ORDER", "name" => Loc::getMessage('DOC_ORDER'), "sort" => "PROPERTY_ORDER", "default" => true, "editable" => false),
                array("id" => "ORGANIZATION", "name" => Loc::getMessage('DOC_ORGANIZATION'),  "sort" => "PROPERTY_ORGANIZATION", "default" => true, "editable" => false),
            ),
            'ROWS' => $arResult['ROWS'],
            'AJAX_MODE' => 'Y',
            ...
            "TOTAL_ROWS_COUNT" => $arResult['TOTOAL_COUNT'],
