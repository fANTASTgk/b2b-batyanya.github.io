...
<? if (count($arResult["ITEMS"]) > 0): ?>
    <? foreach ($arResult["ITEMS"] as $arItem): ?>
        ...
        ?>
        <div class="col-lg-6">
            <div class="card blog-horizontal" id="<?= $this->GetEditAreaId($arItem['ID']); ?>">
                <div class="card-body">
                    <? if ($arParams["DISPLAY_PICTURE"] != "N" && is_array($arItem["PREVIEW_PICTURE"])): ?>
                        <div class="card-img-actions me-3">
                            ...
                            <? if (!$arParams["HIDE_LINK_WHEN_NO_DETAIL"] || ($arItem["DETAIL_TEXT"] && $arResult["USER_HAVE_ACCESS"])): ?>
                                    <a class="card-img card-img-actions-overlay"
                    ...
                    <? if (($arParams["DISPLAY_NAME"] != "N" && $arItem["NAME"]) || $arItem["FIELDS"]): ?>
                        <div class="mb-3">
                    ...
                    <? if ($arItem["PREVIEW_TEXT"]): ?>
                        <p class="mb-3"><? echo $arItem["PREVIEW_TEXT"] ?></p>
                    <? endif; ?>
