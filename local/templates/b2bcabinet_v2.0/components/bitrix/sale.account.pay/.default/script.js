...
BX.saleAccountPay = (function()
{
						...
						data:
							{
								...
								paySystemId: this.wrapper.querySelector('.nav-link.blank_personal-payment_method-button.active').dataset.id,
	...
	{
		const activePayBtn = this.changeInputContainer.querySelector('.js-fixedpay-item.btn-primary');

		if (activePayBtn) {
			activePayBtn.classList.remove("btn-primary")
		}
	};
