                        ...
                        <div class="card-body">
                            <form action="#">
                                        ...
                                        <div class="form-group row js-fixedpay-container">
                                            ...
                                            <div class="col-lg-9 d-flex flex-wrap gap-2">
                                                ...
                                                foreach ($arParams["SELL_TOTAL"] as $valueChanging) {
                                                    ?>
                                                    <button type="button" class="btn js-fixedpay-item btn-pay">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="blank_invoices-payment_method">
                                                ...
                                                foreach ($arResult['PAYSYSTEMS_LIST'] as $key => $paySystem) {
                                                    ...
                                                    <li class="nav-item">
                                                        ...
                                                        >
                                                            ...
                                                            <i class="<?= (!empty($styleClassesForPaySystemIcons[$paySystem['IS_CASH']]) ? $styleClassesForPaySystemIcons[$paySystem['IS_CASH']] : "") ?> me-2"></i>
                                                                </span>
                                                            <?=$paySystem['NAME']?>
                                                        </a>
                                                    </li>
                                ...
                                <div class="text-left">
                                    <button type="button" class="btn btn-primary blank_invoices-pay_button">
