...
foreach($arResult['ORDERS'] as $arOrder)
{
	...
	$aActions = Array(
		array("TEXT"=>Loc::getMessage('SPOL_MORE_ABOUT_ORDER'), "ONCLICK"=>"location.assign('".$b2bOrder->getUrl($arParams['PATH_TO_DETAIL'])."')"),
	);
	...
	$arResult['ROWS'][] = array(
		'data' =>array_merge($arOrder['ORDER'], array(
			"ACCOUNT_NUMBER" => Loc::getMessage('SPOL_PSEUDO_ORDER', ['#ID#' => $arOrder['ORDER']['ID']]),
