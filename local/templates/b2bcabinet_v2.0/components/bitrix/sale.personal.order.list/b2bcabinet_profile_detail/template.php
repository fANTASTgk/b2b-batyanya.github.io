    ...
    <div class="personal_list_order">
        <div class="main-ui-filter-search-wrapper">
            ...
            $APPLICATION->IncludeComponent(
                ...
                "b2bcabinet",
                array(
                    "FILTER_ID" => "PROFILE_ORDER_LIST",
                    "GRID_ID" => "PROFILE_ORDER_LIST",
                    "FILTER" => array(
                        array("id"=>"ACCOUNT_NUMBER", "name"=>GetMessage('SPOL_ORDER_FIELD_NAME_ID')),
        ...
        $APPLICATION->IncludeComponent(
            ...
            array(
                'GRID_ID'   => 'PROFILE_ORDER_LIST',
                'HEADERS' => array(
                    array("id"=>"ACCOUNT_NUMBER", "name"=>"", "sort"=>"ID", "default"=>true, "editable"=>false),
                    array("id"=>"STATUS", "name"=>GetMessage('SPOL_ORDER_FIELD_NAME_STATUS'), "sort"=>"STATUS", "default"=>true, "editable"=>true),
                    array("id"=>"PAYMENT_METHOD", "name"=>GetMessage('B2B_SPOL_ORDER_FIELD_NAME_PAYMENT_METHOD'), "default"=>true, "sort"=>"PAY_SYSTEM_ID"),
                    array("id"=>"DATE_INSERT", "name"=>GetMessage('SPOL_ORDER_FIELD_NAME_DATE'), "sort"=>"DATE_INSERT", "default"=>true, "editable"=>false),
                    array("id"=>"BUYER", "name"=>GetMessage('SPOL_ORDER_FIELD_NAME_BUYER'), "default"=>true),
                    ...
                    array("id"=>"SHIPMENT_METHOD", "name"=>GetMessage('SPOL_ORDER_FIELD_NAME_SHIPMENT_METHOD'), "sort"=>"DELIVERY_ID", "default"=>true),
...
//                'NAV_STRING'       => $arResult['NAV_STRING'],
                "TOTAL_ROWS_COUNT"  => is_array($arResult['ROWS']) ? count($arResult['ROWS']) : 0,
