	...
	false
        ...
        $APPLICATION->IncludeComponent(
            ...
            array(
                'GRID_ID'   => 'ORDER_LIST',
                'HEADERS' => array(
                    array("id"=>"ACCOUNT_NUMBER", "name"=>GetMessage('SPOL_ORDER_FIELD_NAME_ID'), "sort"=>"ID", "default"=>true, "editable"=>false),
                ...
                "TOTAL_ROWS_COUNT"  =>  $arResult["USER_ORDERS_COUNT"] ?: count(is_array($arResult['ROWS']) ? $arResult['ROWS'] : []),
