                ...
                <?foreach ($arResult["DATA"] as $fileID => $data):?>
                    <tr class="table-active table-border-double">
                        ...
                        <td class="text-right result__count-products">
                            <span class="badge bg-success rounded-pill"><?=$data["PRODUCTS_ADDED"] ? count($data["PRODUCTS_ADDED"]) : 0?></span>
                            <span class="badge bg-danger rounded-pill"><?=$data["PRODUCTS_NO_ADDED"] ? count($data["PRODUCTS_NO_ADDED"]) : 0?></span>
                        </td>
                    </tr>
                        ...
                        <?foreach ($data["PRODUCTS_ADDED"] as $prodAdd):?>
                                <tr>
                                    <td class="text-center">
                                        <i class="ph-check text-success fw-bold"></i>
                                    </td>
                                    <td>
                    ...
                    <?if($data["PRODUCTS_NO_ADDED"]):?>
                        <?foreach ($data["PRODUCTS_NO_ADDED"] as $prodNoAdd):?>
                            <tr>
                                <td class="text-center">
                                    <i class="ph-x text-danger fw-bold"></i>
                                </td>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div>
