(function () {
    ...
    window.JCB2BExcelImport = function (params) {
        ...
        this.templateSignsString = params.templateSignsString || '';
    ...
    window.JCB2BExcelImport.prototype =
        {
            importFilesAction: function () {
                ...
                var request = BX.ajax.runComponentAction('sotbit:b2bcabinet.excel.import', 'importExcel', {
                    ...
                    data:{
                        ...
                        sotbit_set_site_template: this.templateSignsString,
                    }
                });
                ...
                request.then(
                    function (response) {
                        ...
                        BX.onCustomEvent("UpdateQuantityOnRequest");
                        this.hideError();
                        this.resetForm();
            ...
            showWait: function () {
                ...
                iconContainer.setAttribute("class", "spinner-grow me-2");
            },
            closeWait: function () {
