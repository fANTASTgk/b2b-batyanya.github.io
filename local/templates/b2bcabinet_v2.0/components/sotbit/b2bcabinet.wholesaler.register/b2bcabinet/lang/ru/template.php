...
$MESS["REGISTER_CAPTCHA_PLACEHOLDER"] = "Введите текст с картинки";
$MESS["REGISTER_CAPTCHA_RELOAD"] = "Обновить";
...
$MESS["REGISTER_FIELD_PHONE_NUMBER"] = "Телефон для регистрации";
...
$MESS["MAIN_REGISTER_AUTH"] = '<h6 class="mb-3 font-weight-semibold">Вы зарегистрированы на сайте и успешно авторизованы.</h6>';
...
$MESS["REGISTER_SUCCESS_BTN"] = 'Ок';
$MESS["REGISTER_BTN_MULTIPLE"] = 'Добавить';
$MESS["REGISTER_FIELD_PLACEHOLDER"] = 'Введите #FIELD#';
$MESS["REGISTER_FIELD_PLACEHOLDER_DEFAULT"] = 'данные';
$MESS["REGISTER_EMAIL_SENT"] = '<h6 class="mb-3 font-weight-semibold">На указанный в форме E-mail было выслано письмо с информацией о подтверждении регистрации.</h6>';
?>