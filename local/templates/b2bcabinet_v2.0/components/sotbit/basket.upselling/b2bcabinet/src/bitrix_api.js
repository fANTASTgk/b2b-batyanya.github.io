...
export const Api = {
    ...
    async addBasket(productId, quantity, setQuantityView, productProps) {
        ...
        try {
            ...
            for (var i = 0; i<error.errors.length; i++) {
                ...
                if (typeof error.errors[i].code.QUANTITY !== 'undefined' || error.errors[i].code.QUANTITY === null) {
                    setQuantityView(+error.errors[i].code.QUANTITY)
                }
            }
