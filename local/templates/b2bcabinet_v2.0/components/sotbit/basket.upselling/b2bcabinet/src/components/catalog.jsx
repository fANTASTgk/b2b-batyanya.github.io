...
export const Catalog = () => {
    ...
    const headerDom = React.useRef(null);
    ...
    React.useEffect(() => {
        ...
        Helper.fixPaddingHeader(listDom, headerDom);
    ...
    }, [listDom, headerDom, state.CURRENT_PAGE, state.NUMBER_OF_PAGES]);
    ...
    return <div className="upselling__catalog-list">
        <ul className="catalog-list">
            <li className="catalog-list__header" ref={headerDom}>
            ...
            <div ref={listDom}
                ...
                {list.length > 0 ? list.map(prod => <CatalogItem key={prod.b_catalog_productID}
                    prod={prod}
                    sendProductToBasket={(id, quantity, setQuantityView, props, inBasketId) =>{
                        dispatch(ActionType.thuncAddBasket(id, quantity, setQuantityView, props, inBasketId))}}
